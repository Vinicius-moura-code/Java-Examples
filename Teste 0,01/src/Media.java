...
public class Media {
	...
	public static void main(String[] args) {
		...
		Qui = Tec.nextDouble();
		System.out.println("Digite um valor para Ed.Fisíca");
		Ef = Tec.nextDouble();
